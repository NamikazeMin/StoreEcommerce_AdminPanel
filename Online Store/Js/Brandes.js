...
{
    var dashboadr=document.getElementById("brandes");
    dashboadr.classList.add("menuselect");
}

var txtsearch=document.getElementById("txtsearch"),
    btnsearch=document.getElementById("btnsearch"),
    brandes_table=document.getElementById("brandes_table"),
    ...
    { 
        ...
        xhttp.onreadystatechange=function()
        {
            if(this.readyState==4 && this.status==200)
            {
                ...
                {
                    brandes_table.children[1].innerHTML=data;
                }
                else
                {
        ...
        xhttp.send("value="+txtsearch.value+"&data=brandes");
        txtsearch.value="";
    }
