...
{
    var dashboadr=document.getElementById("categories");
    dashboadr.classList.add("menuselect");
}

var txtsearch=document.getElementById("txtsearch"),
    btnsearch=document.getElementById("btnsearch"),
    categories_table=document.getElementById("categories_table"),
    ...
    { 
        ...
        xhttp.onreadystatechange=function()
        {
            if(this.readyState==4 && this.status==200)
            {
                ...
                {
                    categories_table.children[1].innerHTML=data;
                }
                else
                {
        ...
        xhttp.send("value="+txtsearch.value+"&data=categories");
        txtsearch.value="";
    }
